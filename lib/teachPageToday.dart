...
class PageTeachToday extends StatefulWidget{
  @override
  _PageTeachToday createState() => _PageTeachToday();
}

class _PageTeachToday extends State with TickerProviderStateMixin {
  @override
